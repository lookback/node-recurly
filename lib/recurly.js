(function(){
  ...
  module.exports = function(config){
    ...
    this.subscriptions = {
      ...
      createWithXML: function(xml, callback){
        t.request(routes.subscriptions.create, callback, xml);
      },
      ...
      updateWithXML: function(uuid, xml, callback) {
        t.request(utils.addParams(routes.subscriptions.update, {uuid: uuid}), callback, xml);
      },
    ...
    this.usage = {
      log: function(subscription_uuid, add_on_code, details, callback) {
        t.request(utils.addParams(routes.subscription_usage_records.log, {subscription_uuid: subscription_uuid, add_on_code: add_on_code}), callback, new Js2xml('subscription', details).toString())
      }
    }
