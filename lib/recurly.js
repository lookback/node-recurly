  ...
  module.exports = function(config){
    ...
    this.usage = {
      log: function(subscription_uuid, add_on_code, details, callback) {
        t.request(utils.addParams(routes.subscription_usage_records.log, {subscription_uuid: subscription_uuid, add_on_code: add_on_code}), callback, new Js2xml('usage', details).toString())
      }
    }
