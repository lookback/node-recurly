...
exports.subscription_usage_records = {
	getObject: ['/v2/subscriptions/:subscription_uuid/add_ons/:add_on_code/usage', 'GET'],
	list: ['/v2/subscriptions/:subscription_uuid/add_ons/:add_on_code/usage?:query_param=:value', 'GET'],
